...
class ContractWriter:
    def __init__(self, node_url=None, private_key=None, contract_address=None):
        ...
        if not self.w3.is_connected():
            raise ConnectionError("Не удалось подключиться к узлу")

        print(f"Подключено к узлу Ethereum")
        ...
        if contract_address:
            ...
            try:
                with open("Contract_Test_address.txt", "r") as f:
        ...
        # Загрузка ABI
        try:
            with open("Contract_Test_abi.json", "r") as f:
    ...
    def block_info(self, block_number):
        """
...
def main():
    ...
    print("=" * 60)
    print("Установка значения в смарт-контракте Contract_Test")
    print("=" * 60)
