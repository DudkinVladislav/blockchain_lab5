    ...
    def __init__(self, node_url=None, contract_address=None):
        ...
        if contract_address:
            ...
            try:
                ...
                raise ValueError(
                    "Адрес контракта не найден. Укажите его вручную или убедитесь что Contract_Test_address.txt существует")
...
def main():
    ...
    print("=" * 60)
    print("Чтение значения из смарт-контракта Contract_Test")
    print("=" * 60)
